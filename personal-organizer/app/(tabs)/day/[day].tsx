...
export default function dayPage() {
  ...
  const [buttonPressed, setButtonPressed] =
    useMMKVObject<boolean>("updateWithoutSave");
  ...
  useEffect(() => {
    ...
    if (days) {
      const generateForm = (
        habitsByCategory: { [key: string]: Habit[] },
        editable: boolean,
      ) => {
              ...
              return (
                <View key={"Habit" + h.habitID + "Button"}>
                  <CustomButton
                    ...
                    disabled={!editable}
                    onPress={() => {
                      handleInputChange(h.habitID, !data?.[h.habitID]);
                    }}
                    color={
                      (data?.[h.habitID]
                        ? buttonColorTrue
                        : buttonColorFalse) || "#FFA500"
                    }
                  />
                </View>
              );
              ...
              return (
                ...
                >
                  ...
                  <TextInput
                    ...
                    value={test2}
                    onChangeText={(value) =>
                      handleInputChange(h.habitID, value)
                    }
      ...
      if (habits) {
        ...
        setForm(
          generateForm(
            habitsByCategory,
            generateDifferentDaysKey(todaysKey, 1) === local.day,
          ),
        );
      }
    }
